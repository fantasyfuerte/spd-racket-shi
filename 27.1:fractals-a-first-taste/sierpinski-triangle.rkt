...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname sierpinski-triangle) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;Number -> Image
;creates a Sierpinski triangle of size side
