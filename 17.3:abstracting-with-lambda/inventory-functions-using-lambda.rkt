...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname inventory-functions-using-lambda) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))

(define-struct inv-i [name sales-price acq-price])
...
(define (sort-by-profit l)
  (sort l (lambda (i1 i2)(> (- (inv-i-sales-price i1) (inv-i-acq-price i1))
