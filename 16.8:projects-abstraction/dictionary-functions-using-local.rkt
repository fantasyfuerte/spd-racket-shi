...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname dictionary-functions-using-local) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
