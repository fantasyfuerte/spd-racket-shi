...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname space-war-abstracted) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;(make-ufo Posn Direction Number [Lists-of Posn])
...
;(make-tank Number [List-Of Posn] Number)
...
;interpretation: an arbitrary list of ITEM
