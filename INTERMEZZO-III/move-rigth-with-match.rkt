...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname move-rigth-with-match) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
